...
// Oturum yapılandırması - HTTP için
app.use(session({
...
app.listen(HTTP_PORT, async () => {
    ...
    console.log(`🌐 HTTP Hosting Kontrol Paneli ${HTTP_PORT} portunda çalışıyor`);
    console.log(`🔗 Panel Adresi: http://${serverIP}:${HTTP_PORT}`);
    console.log(`🔗 Giriş: http://${serverIP}:${HTTP_PORT}/login`);
    console.log(`👤 Varsayılan kullanıcı: admin / admin123`);
    console.log(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
    console.log(`🎯 HTTP ERİŞİM: http://${serverIP}:${HTTP_PORT}`);
}); 